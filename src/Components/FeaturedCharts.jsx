...
const FeaturedCharts = () => {
  ...
  return (
    <div className="flex-1 sm:p-6 sm:space-y-10">
      <div className="sm:bg-gradient-to-r sm:from-indigo-900/40 sm:via-purple-800/30 sm:to-pink-700/20 sm:rounded-2xl sm:p-6 sm:shadow-lg my-4 sm:my-0">
